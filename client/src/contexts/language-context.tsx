...
const translations = {
  en: {
    ...
    noRelevantTextFound: "No relevant text found",
  ...
  vi: {
    ...
    noRelevantTextFound: "Không tìm thấy văn bản liên quan",
    noTextDetected: "Không phát hiện văn bản",
    ...
    cancel: "Hủy",
    success: "Thành Công",
    downloadImageSuccess: "Tải ảnh thành công",
    warning: "Cảnh Báo",
    info: "Thông Tin",
    error: "Lỗi",
  }
