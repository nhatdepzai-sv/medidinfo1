...
const additionalMedications: Medication[] = [
  ...
  },
  {
    ...
    warningsVi: ["Tích tụ dịch", "độc tính gan", "chuột rút", "Theo dõi máu định kỳ"]
  },
  
  // Additional Cancer/Oncology Medications
  {
    id: "exemestane-001",
    name: "Exemestane",
    nameVi: "Exemestane",
    genericName: "Exemestane",
    genericNameVi: "Exemestane", 
    category: "Aromatase Inhibitor",
    categoryVi: "Ức chế Aromatase",
    primaryUse: "Treats advanced breast cancer in postmenopausal women after tamoxifen therapy",
    primaryUseVi: "Điều trị ung thư vú giai đoạn muộn ở phụ nữ mãn kinh sau điều trị tamoxifen",
    adultDosage: "25mg once daily after meals",
    adultDosageVi: "25mg một lần mỗi ngày sau bữa ăn",
    maxDosage: "25mg daily",
    maxDosageVi: "25mg mỗi ngày",
    warnings: ["Osteoporosis risk", "hot flashes", "fatigue", "Joint and muscle pain"],
    warningsVi: ["Nguy cơ loãng xương", "bốc hỏa", "mệt mỏi", "Đau khớp và cơ"]
  },
  {
    id: "fulvestrant-001",
    name: "Fulvestrant",
    ...
    genericNameVi: "Fulvestrant",
    category: "Selective Estrogen Receptor Degrader (SERD)",
    categoryVi: "Thuốc phá hủy thụ thể estrogen chọn lọc",
    primaryUse: "Treats hormone receptor-positive metastatic breast cancer",
    primaryUseVi: "Điều trị ung thư vú di căn dương tính thụ thể hormone",
    adultDosage: "500mg intramuscular injection every 2 weeks for 3 doses, then monthly",
    adultDosageVi: "Tiêm bắp 500mg mỗi 2 tuần cho 3 liều, sau đó hàng tháng",
    maxDosage: "500mg monthly",
    maxDosageVi: "500mg hàng tháng",
    warnings: ["Injection site reactions", "nausea", "fatigue", "Hot flashes"],
    warningsVi: ["Phản ứng tại chỗ tiêm", "buồn nôn", "mệt mỏi", "Bốc hỏa"]
  },
  {
    id: "palbociclib-001",
    name: "Palbociclib",
    ...
    genericNameVi: "Palbociclib",
    category: "CDK4/6 Inhibitor",
    categoryVi: "Ức chế CDK4/6",
    primaryUse: "Treats HR-positive, HER2-negative advanced breast cancer",
    primaryUseVi: "Điều trị ung thư vú HR dương tính, HER2 âm tính giai đoạn muộn",
    adultDosage: "125mg once daily for 21 days, then 7 days off",
    adultDosageVi: "125mg một lần mỗi ngày trong 21 ngày, sau đó nghỉ 7 ngày",
    maxDosage: "125mg daily during treatment cycles",
    maxDosageVi: "125mg mỗi ngày trong chu kỳ điều trị",
    warnings: ["Neutropenia", "fatigue", "nausea", "Regular blood count monitoring"],
    warningsVi: ["Giảm bạch cầu trung tính", "mệt mỏi", "buồn nôn", "Theo dõi số lượng máu thường xuyên"]
  },
  {
    id: "ribociclib-001",
    name: "Ribociclib",
    ...
    genericNameVi: "Ribociclib",
    category: "CDK4/6 Inhibitor",
    categoryVi: "Ức chế CDK4/6",
    primaryUse: "Treats hormone receptor-positive, HER2-negative advanced breast cancer",
    primaryUseVi: "Điều trị ung thư vú thụ thể hormone dương tính, HER2 âm tính giai đoạn muộn",
    adultDosage: "600mg once daily for 21 days, then 7 days off",
    adultDosageVi: "600mg một lần mỗi ngày trong 21 ngày, sau đó nghỉ 7 ngày",
    maxDosage: "600mg daily during treatment cycles",
    maxDosageVi: "600mg mỗi ngày trong chu kỳ điều trị",
    warnings: ["QT prolongation", "neutropenia", "hepatotoxicity", "ECG monitoring required"],
    warningsVi: ["Kéo dài QT", "giảm bạch cầu trung tính", "độc tính gan", "Cần theo dõi điện tâm đồ"]
  },
  {
    id: "abemaciclib-001",
    name: "Abemaciclib",
    ...
    genericNameVi: "Abemaciclib",
    category: "CDK4/6 Inhibitor",
    categoryVi: "Ức chế CDK4/6",
    primaryUse: "Treats hormone receptor-positive, HER2-negative advanced breast cancer",
    primaryUseVi: "Điều trị ung thư vú thụ thể hormone dương tính, HER2 âm tính giai đoạn muộn",
    adultDosage: "150mg twice daily continuously",
    adultDosageVi: "150mg hai lần mỗi ngày liên tục",
    maxDosage: "300mg daily",
    maxDosageVi: "300mg mỗi ngày",
    warnings: ["Diarrhea", "neutropenia", "fatigue", "Monitor for hepatotoxicity"],
    warningsVi: ["Tiêu chảy", "giảm bạch cầu trung tính", "mệt mỏi", "Theo dõi độc tính gan"]
  },
  {
    id: "trastuzumab-001",
    name: "Trastuzumab",
    ...
    genericNameVi: "Trastuzumab",
    category: "HER2 Monoclonal Antibody",
    categoryVi: "Kháng thể đơn dòng HER2",
    primaryUse: "Treats HER2-positive breast cancer and gastric cancer",
    primaryUseVi: "Điều trị ung thư vú và ung thư dạ dày HER2 dương tính",
    adultDosage: "Loading dose 4-8mg/kg IV, then 2-6mg/kg weekly or every 3 weeks",
    adultDosageVi: "Liều khởi đầu 4-8mg/kg tĩnh mạch, sau đó 2-6mg/kg hàng tuần hoặc 3 tuần một lần",
    maxDosage: "Based on body weight and schedule",
    maxDosageVi: "Dựa trên cân nặng và lịch trình",
    warnings: ["Cardiotoxicity", "infusion reactions", "pulmonary toxicity", "Monitor cardiac function"],
    warningsVi: ["Độc tính tim", "phản ứng truyền", "độc tính phổi", "Theo dõi chức năng tim"]
  },
  {
    id: "pertuzumab-001",
    name: "Pertuzumab",
    ...
    genericNameVi: "Pertuzumab",
    category: "HER2 Monoclonal Antibody",
    categoryVi: "Kháng thể đơn dòng HER2",
    primaryUse: "Treats HER2-positive metastatic breast cancer in combination with trastuzumab",
    primaryUseVi: "Điều trị ung thư vú di căn HER2 dương tính kết hợp với trastuzumab",
    adultDosage: "Loading dose 840mg IV, then 420mg every 3 weeks",
    adultDosageVi: "Liều khởi đầu 840mg tĩnh mạch, sau đó 420mg mỗi 3 tuần",
    maxDosage: "420mg every 3 weeks maintenance",
    maxDosageVi: "420mg mỗi 3 tuần duy trì",
    warnings: ["Cardiac dysfunction", "infusion reactions", "diarrhea", "Use with trastuzumab"],
    warningsVi: ["Rối loạn chức năng tim", "phản ứng truyền", "tiêu chảy", "Dùng cùng trastuzumab"]
  },
  {
    id: "bevacizumab-001",
    name: "Bevacizumab",
    ...
    genericNameVi: "Bevacizumab",
    category: "VEGF Inhibitor",
    categoryVi: "Ức chế VEGF",
    primaryUse: "Treats colorectal, lung, kidney, cervical, and ovarian cancers",
    primaryUseVi: "Điều trị ung thư đại trực tràng, phổi, thận, cổ tử cung và buồng trứng",
    adultDosage: "5-15mg/kg IV every 2-3 weeks depending on cancer type",
    adultDosageVi: "5-15mg/kg tĩnh mạch mỗi 2-3 tuần tùy loại ung thư",
    maxDosage: "15mg/kg every 2-3 weeks",
    maxDosageVi: "15mg/kg mỗi 2-3 tuần",
    warnings: ["Bleeding risk", "wound healing problems", "hypertension", "Monitor for perforation"],
    warningsVi: ["Nguy cơ chảy máu", "vấn đề lành vết thương", "tăng huyết áp", "Theo dõi nguy cơ thủng"]
  },
  {
    id: "cetuximab-001",
    name: "Cetuximab",
    ...
    genericNameVi: "Cetuximab",
    category: "EGFR Inhibitor",
    categoryVi: "Ức chế EGFR",
    primaryUse: "Treats metastatic colorectal cancer and head/neck squamous cell carcinoma",
    primaryUseVi: "Điều trị ung thư đại trực tràng di căn và ung thư biểu mô vảy đầu cổ",
    adultDosage: "Loading dose 400mg/m², then 250mg/m² weekly",
    adultDosageVi: "Liều khởi đầu 400mg/m², sau đó 250mg/m² hàng tuần",
    maxDosage: "400mg/m² loading, then 250mg/m² weekly",
    maxDosageVi: "400mg/m² khởi đầu, sau đó 250mg/m² hàng tuần",
    warnings: ["Severe infusion reactions", "skin toxicity", "hypomagnesemia", "KRAS wild-type required"],
    warningsVi: ["Phản ứng truyền nghiêm trọng", "độc tính da", "hạ magie máu", "Cần KRAS dại"]
  },
  {
    id: "rituximab-001",
    name: "Rituximab",
    ...
    category: "CD20 Monoclonal Antibody",
    categoryVi: "Kháng thể đơn dòng CD20",
    primaryUse: "Treats non-Hodgkin's lymphoma, chronic lymphocytic leukemia, and autoimmune diseases",
    primaryUseVi: "Điều trị u lympho không Hodgkin, bạch cầu lympho mãn tính và bệnh tự miễn",
    adultDosage: "375mg/m² IV weekly for 4-8 weeks, or various schedules",
    adultDosageVi: "375mg/m² tĩnh mạch hàng tuần trong 4-8 tuần hoặc lịch trình khác",
    maxDosage: "Based on body surface area",
    maxDosageVi: "Dựa trên diện tích cơ thể",
    warnings: ["Tumor lysis syndrome", "severe mucocutaneous reactions", "hepatitis B reactivation", "PML risk"],
    warningsVi: ["Hội chứng tan u", "phản ứng niêm mạc da nghiêm trọng", "tái hoạt viêm gan B", "Nguy cơ PML"]
  },
  {
    id: "pembrolizumab-001",
    name: "Pembrolizumab",
    nameVi: "Pembrolizumab",
    genericName: "Pembrolizumab",
    genericNameVi: "Pembrolizumab",
    category: "PD-1 Inhibitor (Immunotherapy)",
    categoryVi: "Ức chế PD-1 (Liệu pháp miễn dịch)",
    primaryUse: "Treats melanoma, lung cancer, and various other cancers with PD-L1 expression",
    primaryUseVi: "Điều trị u melanoma, ung thư phổi và nhiều ung thư khác có biểu hiện PD-L1",
    adultDosage: "200mg IV every 3 weeks or 400mg every 6 weeks",
    adultDosageVi: "200mg tĩnh mạch mỗi 3 tuần hoặc 400mg mỗi 6 tuần",
    maxDosage: "400mg every 6 weeks",
    maxDosageVi: "400mg mỗi 6 tuần",
    warnings: ["Immune-related adverse events", "pneumonitis", "colitis", "Monitor for autoimmune toxicities"],
    warningsVi: ["Tác dụng phụ liên quan miễn dịch", "viêm phổi", "viêm đại tràng", "Theo dõi độc tính tự miễn"]
  },
  {
    id: "nivolumab-001",
    name: "Nivolumab", 
    ...
    genericNameVi: "Nivolumab",
    category: "PD-1 Inhibitor (Immunotherapy)",
    categoryVi: "Ức chế PD-1 (Liệu pháp miễn dịch)",
    primaryUse: "Treats melanoma, lung cancer, kidney cancer, and Hodgkin lymphoma",
    primaryUseVi: "Điều trị u melanoma, ung thư phổi, ung thư thận và u lympho Hodgkin",
    adultDosage: "240mg IV every 2 weeks or 480mg every 4 weeks",
    adultDosageVi: "240mg tĩnh mạch mỗi 2 tuần hoặc 480mg mỗi 4 tuần",
    maxDosage: "480mg every 4 weeks",
    maxDosageVi: "480mg mỗi 4 tuần",
    warnings: ["Immune-mediated adverse reactions", "pneumonitis", "hepatitis", "Endocrine disorders"],
    warningsVi: ["Phản ứng phụ do miễn dịch", "viêm phổi", "viêm gan", "Rối loạn nội tiết"]
  },
  {
    id: "ipilimumab-001",
    name: "Ipilimumab",
    ...
    genericNameVi: "Ipilimumab",
    category: "CTLA-4 Inhibitor (Immunotherapy)",
    categoryVi: "Ức chế CTLA-4 (Liệu pháp miễn dịch)",
    primaryUse: "Treats advanced melanoma and renal cell carcinoma",
    primaryUseVi: "Điều trị u melanoma giai đoạn muộn và ung thư tế bào thận",
    adultDosage: "3mg/kg IV every 3 weeks for 4 doses",
    adultDosageVi: "3mg/kg tĩnh mạch mỗi 3 tuần cho 4 liều",
    maxDosage: "3mg/kg every 3 weeks",
    maxDosageVi: "3mg/kg mỗi 3 tuần",
    warnings: ["Severe immune-mediated reactions", "diarrhea/colitis", "hepatotoxicity", "Endocrinopathy"],
    warningsVi: ["Phản ứng miễn dịch nghiêm trọng", "tiêu chảy/viêm đại tràng", "độc tính gan", "Rối loạn nội tiết"]
  },
  {
    id: "capecitabine-001",
    name: "Capecitabine",
    ...
    genericNameVi: "Capecitabine",
    category: "Antimetabolite Chemotherapy",
    categoryVi: "Hóa trị chống chuyển hóa",
    primaryUse: "Treats colorectal and breast cancers",
    primaryUseVi: "Điều trị ung thư đại trực tràng và ung thư vú",
    adultDosage: "1000-1250mg/m² twice daily for 14 days, then 7 days rest",
    adultDosageVi: "1000-1250mg/m² hai lần mỗi ngày trong 14 ngày, sau đó nghỉ 7 ngày",
    maxDosage: "2500mg/m² daily during treatment cycles",
    maxDosageVi: "2500mg/m² mỗi ngày trong chu kỳ điều trị",
    warnings: ["Hand-foot syndrome", "diarrhea", "myelosuppression", "Take with food"],
    warningsVi: ["Hội chứng bàn tay-bàn chân", "tiêu chảy", "ức chế tủy xương", "Uống cùng thức ăn"]
  },
  {
    id: "gemcitabine-001",
    name: "Gemcitabine",
    ...
    genericNameVi: "Gemcitabine Hydrochloride",
    category: "Antimetabolite Chemotherapy",
    categoryVi: "Hóa trị chống chuyển hóa",
    primaryUse: "Treats pancreatic, lung, breast, and ovarian cancers",
    primaryUseVi: "Điều trị ung thư tuyến tụy, phổi, vú và buồng trứng",
    adultDosage: "1000-1250mg/m² IV weekly for 3 weeks, then 1 week rest",
    adultDosageVi: "1000-1250mg/m² tĩnh mạch hàng tuần trong 3 tuần, sau đó nghỉ 1 tuần",
    maxDosage: "1250mg/m² weekly",
    maxDosageVi: "1250mg/m² hàng tuần",
    warnings: ["Myelosuppression", "pulmonary toxicity", "hemolytic uremic syndrome", "Monitor blood counts"],
    warningsVi: ["Ức chế tủy xương", "độc tính phổi", "hội chứng tan máu urê", "Theo dõi số lượng máu"]
  },
  {
    id: "paclitaxel-001",
    name: "Paclitaxel",
    ...
    primaryUse: "Treats breast, ovarian, lung, and other solid tumors",
    primaryUseVi: "Điều trị ung thư vú, buồng trứng, phổi và các u rắn khác",
    adultDosage: "135-175mg/m² IV every 3 weeks or 80mg/m² weekly",
    adultDosageVi: "135-175mg/m² tĩnh mạch mỗi 3 tuần hoặc 80mg/m² hàng tuần",
    maxDosage: "175mg/m² every 3 weeks",
    maxDosageVi: "175mg/m² mỗi 3 tuần",
    warnings: ["Severe hypersensitivity reactions", "peripheral neuropathy", "myelosuppression", "Premedication required"],
    warningsVi: ["Phản ứng quá mẫn nghiêm trọng", "bệnh thần kinh ngoại biên", "ức chế tủy xương", "Cần tiền điều trị"]
  },
  {
    id: "docetaxel-001",
    name: "Docetaxel",
    ...
    genericNameVi: "Docetaxel",
    category: "Taxane Chemotherapy",
    categoryVi: "Hóa trị Taxane",
    primaryUse: "Treats breast, lung, prostate, and head/neck cancers",
    primaryUseVi: "Điều trị ung thư vú, phổi, tuyến tiền liệt và đầu cổ",
    adultDosage: "60-100mg/m² IV every 3 weeks",
    adultDosageVi: "60-100mg/m² tĩnh mạch mỗi 3 tuần",
    maxDosage: "100mg/m² every 3 weeks",
    maxDosageVi: "100mg/m² mỗi 3 tuần",
    warnings: ["Fluid retention", "severe neutropenia", "neuropathy", "Premedication with steroids required"],
    warningsVi: ["Tích tụ dịch", "giảm bạch cầu trung tính nghiêm trọng", "bệnh thần kinh", "Cần tiền điều trị steroid"]
  },
  {
    id: "carboplatin-001",
    name: "Carboplatin",
    ...
    genericNameVi: "Carboplatin",
    category: "Platinum Chemotherapy",
    categoryVi: "Hóa trị Platin",
    primaryUse: "Treats ovarian, lung, and head/neck cancers",
    primaryUseVi: "Điều trị ung thư buồng trứng, phổi và đầu cổ",
    adultDosage: "AUC 4-6 IV every 3-4 weeks (dose calculated by Calvert formula)",
    adultDosageVi: "AUC 4-6 tĩnh mạch mỗi 3-4 tuần (liều tính theo công thức Calvert)",
    maxDosage: "AUC 7 maximum",
    maxDosageVi: "AUC 7 tối đa",
    warnings: ["Myelosuppression", "ototoxicity", "peripheral neuropathy", "Monitor kidney function"],
    warningsVi: ["Ức chế tủy xương", "độc tính tai", "bệnh thần kinh ngoại biên", "Theo dõi chức năng thận"]
  },
  {
    id: "cisplatin-001",
    name: "Cisplatin",
    ...
    category: "Platinum Chemotherapy",
    categoryVi: "Hóa trị Platin",
    primaryUse: "Treats testicular, ovarian, bladder, and lung cancers",
    primaryUseVi: "Điều trị ung thư tinh hoàn, buồng trứng, bàng quang và phổi",
    adultDosage: "50-100mg/m² IV every 3-4 weeks",
    adultDosageVi: "50-100mg/m² tĩnh mạch mỗi 3-4 tuần",
    maxDosage: "100mg/m² per cycle",
    maxDosageVi: "100mg/m² mỗi chu kỳ",
    warnings: ["Nephrotoxicity", "ototoxicity", "severe nausea/vomiting", "Adequate hydration essential"],
    warningsVi: ["Độc tính thận", "độc tính tai", "buồn nôn/nôn nghiêm trọng", "Cần đủ nước thiết yếu"]
  },
  {
    id: "oxaliplatin-001",
    name: "Oxaliplatin",
    ...
    genericNameVi: "Oxaliplatin",
    category: "Platinum Chemotherapy",
    categoryVi: "Hóa trị Platin",
    primaryUse: "Treats colorectal cancer, often combined with 5-FU and leucovorin",
    primaryUseVi: "Điều trị ung thư đại trực tràng, thường kết hợp với 5-FU và leucovorin",
    adultDosage: "85mg/m² IV every 2 weeks (FOLFOX regimen)",
    adultDosageVi: "85mg/m² tĩnh mạch mỗi 2 tuần (phác đồ FOLFOX)",
    maxDosage: "130mg/m² every 3 weeks",
    maxDosageVi: "130mg/m² mỗi 3 tuần",
    warnings: ["Cold-induced neuropathy", "acute laryngospasm", "myelosuppression", "Avoid cold exposure"],
    warningsVi: ["Bệnh thần kinh do lạnh", "co thắt thanh quản cấp", "ức chế tủy xương", "Tránh tiếp xúc lạnh"]
  },
  {
    id: "erlotinib-001",
    name: "Erlotinib",
    ...
    genericNameVi: "Erlotinib Hydrochloride",
    category: "EGFR Tyrosine Kinase Inhibitor",
    categoryVi: "Ức chế Tyrosine Kinase EGFR",
    primaryUse: "Treats non-small cell lung cancer and pancreatic cancer",
    primaryUseVi: "Điều trị ung thư phổi không tế bào nhỏ và ung thư tuyến tụy",
    adultDosage: "150mg once daily on empty stomach",
    adultDosageVi: "150mg một lần mỗi ngày khi đói",
    maxDosage: "150mg daily",
    maxDosageVi: "150mg mỗi ngày",
    warnings: ["Skin rash", "diarrhea", "interstitial lung disease", "Take on empty stomach"],
    warningsVi: ["Phát ban da", "tiêu chảy", "bệnh phổi kẽ", "Uống khi đói"]
  },
  {
    id: "gefitinib-001",
    name: "Gefitinib",
    ...
    genericNameVi: "Gefitinib",
    category: "EGFR Tyrosine Kinase Inhibitor",
    categoryVi: "Ức chế Tyrosine Kinase EGFR",
    primaryUse: "Treats EGFR mutation-positive non-small cell lung cancer",
    primaryUseVi: "Điều trị ung thư phổi không tế bào nhỏ đột biến EGFR dương tính",
    adultDosage: "250mg once daily with or without food",
    adultDosageVi: "250mg một lần mỗi ngày có hoặc không có thức ăn",
    maxDosage: "250mg daily",
    maxDosageVi: "250mg mỗi ngày",
    warnings: ["Interstitial lung disease", "hepatotoxicity", "skin reactions", "EGFR mutation testing required"],
    warningsVi: ["Bệnh phổi kẽ", "độc tính gan", "phản ứng da", "Cần xét nghiệm đột biến EGFR"]
  },
  {
    id: "sorafenib-001",
    name: "Sorafenib",
    ...
    genericNameVi: "Sorafenib Tosylate",
    category: "Multikinase Inhibitor",
    categoryVi: "Ức chế đa kinase",
    primaryUse: "Treats hepatocellular carcinoma, renal cell carcinoma, and thyroid cancer",
    primaryUseVi: "Điều trị ung thư tế bào gan, ung thư tế bào thận và ung thư tuyến giáp",
    adultDosage: "400mg twice daily on empty stomach",
    adultDosageVi: "400mg hai lần mỗi ngày khi đói",
    maxDosage: "800mg daily",
    maxDosageVi: "800mg mỗi ngày",
    warnings: ["Hand-foot skin reaction", "diarrhea", "hypertension", "Take without food"],
    warningsVi: ["Phản ứng da bàn tay-bàn chân", "tiêu chảy", "tăng huyết áp", "Uống không cùng thức ăn"]
  },
  {
    id: "sunitinib-001",
    name: "Sunitinib",
    nameVi: "Sunitinib",
    genericName: "Sunitinib Malate",
    genericNameVi: "Sunitinib Malate",
    category: "Multikinase Inhibitor",
    categoryVi: "Ức chế đa kinase",
    primaryUse: "Treats renal cell carcinoma, gastrointestinal stromal tumors, and neuroendocrine tumors",
    primaryUseVi: "Điều trị ung thư tế bào thận, u mô đệm đường tiêu hóa và u thần kinh nội tiết",
    adultDosage: "50mg once daily for 4 weeks, then 2 weeks off",
    adultDosageVi: "50mg một lần mỗi ngày trong 4 tuần, sau đó nghỉ 2 tuần",
    maxDosage: "50mg daily during treatment cycles",
    maxDosageVi: "50mg mỗi ngày trong chu kỳ điều trị",
    warnings: ["Cardiotoxicity", "hepatotoxicity", "hand-foot syndrome", "Monitor cardiac function"],
    warningsVi: ["Độc tính tim", "độc tính gan", "hội chứng bàn tay-bàn chân", "Theo dõi chức năng tim"]
  },
  {
    id: "bortezomib-001",
    name: "Bortezomib",
    ...
    genericNameVi: "Bortezomib",
    category: "Proteasome Inhibitor",
    categoryVi: "Ức chế proteasome",
    primaryUse: "Treats multiple myeloma and mantle cell lymphoma",
    primaryUseVi: "Điều trị u tủy đa phát và u lympho tế bào ngoại vi",
    adultDosage: "1.3mg/m² IV or subcutaneous twice weekly for 2 weeks, then rest",
    adultDosageVi: "1.3mg/m² tĩnh mạch hoặc dưới da hai lần mỗi tuần trong 2 tuần, sau đó nghỉ",
    maxDosage: "1.3mg/m² per dose",
    maxDosageVi: "1.3mg/m² mỗi liều",
    warnings: ["Peripheral neuropathy", "thrombocytopenia", "tumor lysis syndrome", "Monitor blood counts"],
    warningsVi: ["Bệnh thần kinh ngoại biên", "giảm tiểu cầu", "hội chứng tan u", "Theo dõi số lượng máu"]
  },
  {
    id: "lenalidomide-001",
    name: "Lenalidomide",
    ...
    genericNameVi: "Lenalidomide",
    category: "Immunomodulatory Drug",
    categoryVi: "Thuốc điều hóa miễn dịch",
    primaryUse: "Treats multiple myeloma and myelodysplastic syndromes",
    primaryUseVi: "Điều trị u tủy đa phát và hội chứng loạn sản tủy",
    adultDosage: "25mg once daily for 21 days, then 7 days rest",
    adultDosageVi: "25mg một lần mỗi ngày trong 21 ngày, sau đó nghỉ 7 ngày",
    maxDosage: "25mg daily during treatment cycles",
    maxDosageVi: "25mg mỗi ngày trong chu kỳ điều trị",
    warnings: ["Severe birth defects", "thromboembolism", "myelosuppression", "REMS program required"],
    warningsVi: ["Dị tật bẩm sinh nghiêm trọng", "thuyên tắc mạch", "ức chế tủy xương", "Cần chương trình REMS"]
  },
